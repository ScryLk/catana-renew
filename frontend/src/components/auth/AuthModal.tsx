...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className={`w-full max-w-[460px] rounded-[28px] border shadow-2xl p-7 sm:p-9 relative transition-all duration-200 ${
          isDark
        ...
        <div className="mb-6 text-center">
          ...
          <p className={`text-xs ${isDark ? 'text-zinc-400' : 'text-zinc-500'}`}>
            {isRegisterView
              ...
              : 'Acesse o Studio e colabore com os agentes de IA.'}
          </p>
        </div>
        ...
        {!isRegisterView ? (
          ...
          <form onSubmit={handleRegisterSubmit} className="space-y-3">
            ...
            <div className="flex items-start space-x-2 pt-1">
              ...
              <label
                htmlFor="reg-terms"
                className={`text-[11px] leading-tight cursor-pointer select-none ${
                  isDark ? 'text-zinc-400' : 'text-zinc-500'
                }`}
              >
                Concordo com os Termos de Servico e Politica de Privacidade do Catana.
              </label>
            </div>
